...
const defaultConfig = {
  ...
  budget: 260,
  scoring: 'CATEGORY',
  teamNames: ["My Team", "Bob's Team", "Carl's Team", "Don's Team", "Ed's Team"],
};
...
export default function Page({ params }) {
  ...
  return (
    ...
    <div>
      <SideBar/>
      <div className="panel mb-5"><h1 className="text-lg font-bold">Configuration</h1></div>
      <form onSubmit={handleSubmit} className="panel space-y-6">
          ...
          <div className="flex items-center justify-between">
            ...
            <button type="button" className="btn btn-secondary btn-sm" onClick={addTeam}>
              Add Team
            </button>
          </div>
