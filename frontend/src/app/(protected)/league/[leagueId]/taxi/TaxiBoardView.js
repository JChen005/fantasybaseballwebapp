import TaxiRosterTable from './TaxiRosterTable';
import TaxiSlotSummary from './TaxiSlotSummary';
import TaxiTeamTabs from './TaxiTeamTabs';

export default function TaxiBoardView({
  clearEntry,
  currentRows,
  filledCount,
  handlePlayerClick,
        ...
        <div className="flex flex-col gap-4">
          <div className="flex flex-col gap-3 lg:flex-row lg:items-end lg:justify-between">
            ...
            <div className="flex items-center gap-3">
              <TaxiSlotSummary filledCount={filledCount} taxiSlotCount={taxiSlotCount} />
